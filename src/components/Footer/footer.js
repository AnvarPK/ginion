                ...
                <div className="div-block-10">
                    <div className="container-ginion">
                        <div className="div-block-11">
                            <h2 className="heading-2">{language.value === "nl" ? "Nog niet zeker welk model u zoekt?" : "Pas encore certain du modèle que vous souhaitez ?"}</h2><a href="#" className="button w-button">
                                {language.value === "nl" ? "BEKIJK ONS HELE AANBOD" : "Découvrez toute notre gamme"}</a>
                        </div>
                    </div>
                </div>
            </div>
